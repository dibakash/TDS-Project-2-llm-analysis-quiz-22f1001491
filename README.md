...
```bash
git clone https://github.com/dibakash/TDS-Project-2-llm-analysis-quiz-22f1001491.git
cd TDS-Project-2-llm-analysis-quiz-22f1001491
...
pip install uv (or refer to official UV documentation for installation)
...
**Request Body:**
Use actual url in place of example.com url given in the example below
...
**Author**: Dibakash Baruah
**Course**: Tools in Data Science (TDS)
**Institution**: IIT Madras

Disclaimer by- Dibakash Baruah:

This project is built with team effort. Possibly built on top of code shared by students groups. Hence I do not claim to have built this on my own. However, there was good amount of time spent on the this project to figure out that aipipe models were not doing a better job than gemini. So the project as mostly kept as it is.
